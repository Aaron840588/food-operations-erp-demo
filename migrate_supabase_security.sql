...
-- Only service_role receives a direct-data policy. The application database
-- connection already bypasses RLS; anon/authenticated clients remain denied.
...
DECLARE
  ...
  tables TEXT[] := ARRAY[
    ...
    'cleaning_tasks', 'push_subscriptions', 'timesheet_entries', 'warehouses'
  ];
BEGIN
