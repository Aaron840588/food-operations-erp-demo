...
import { Search, Edit3, Save, AlertCircle, ChevronDown, ChevronRight, Package, Gift } from "lucide-react";
...
export default function StockList({
  ...
  const handleSaveGiftSet = async (payload: GiftSetCustomPayload) => {
        ...
        <td className="px-4 py-3 border-r border-slate-200 2xl:px-6 2xl:py-3.5">
          <div className="flex justify-center items-center gap-2">
            ...
            <button
              ...
              className={`flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-xl transition-all duration-150 cursor-pointer ${
  ...
  return (
    <div className="space-y-5 2xl:space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-3 2xl:gap-4 justify-between items-center bg-white p-4 2xl:p-5 border border-slate-200 rounded-2xl shadow-xs">
        <div className="flex gap-2 w-full md:w-auto">
          <Button
            ...
            size="md"
            className="h-[44px] flex-1 rounded-xl text-sm font-bold md:flex-none 2xl:h-12"
            onClick={() => {
        ...
        <div className="flex items-center gap-3 flex-1 max-w-lg">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-[44px] w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pr-4 text-sm font-semibold focus:ring-primary/20 2xl:h-12"
            />
          </div>
      ...
      {stockType === "finished" && (
        <div className="flex flex-wrap items-center justify-between gap-2 pb-2">
          ...
          <Button
            ...
            className="h-10 text-xs font-black rounded-xl border-amber-300 bg-amber-50 text-amber-950 hover:bg-amber-100 shadow-3xs cursor-pointer ml-auto"
            leftIcon={<Gift size={14} className="text-amber-800" />}
          >
            Build Custom Gift Set (Spreads + ₱100)
          </Button>
        </div>
      )}
                                        ...
                                        <td className="px-4 py-3 border-r border-slate-200 2xl:px-6 2xl:py-4">
                                          <div className="flex justify-center items-center gap-2 2xl:gap-3">
                                            ...
                                            <button
                                              ...
                                              className={`ml-1 flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-xl transition-all duration-150 cursor-pointer ${
                                                adjustQty[p.sku] !== undefined &&
                                                adjustQty[p.sku] !== p.warehouse_stock
                                                  ? "bg-primary hover:bg-primary-hover text-white opacity-100 scale-100 shadow-3xs"
                                                  : "bg-slate-100 text-slate-300 opacity-0 scale-95 pointer-events-none"
                        ...
                        <div className="flex flex-col gap-3 bg-[#faf8f5] p-3 rounded-xl border border-[#ece5da] sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <div className="flex min-w-0 items-center gap-2 overflow-x-auto pb-1 sm:pb-0">
                            ...
                            <button
                              ...
                              aria-label={`Save stock level for ${p.product_name}`}
                              className={`flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-lg transition-all duration-150 active:scale-95 ${
                                adjustQty[p.sku] !== undefined &&
                                adjustQty[p.sku] !== p.warehouse_stock
                                    ...
                                    <td className="px-6 py-3.5 border-r border-slate-200">
                                      <div className="flex justify-center items-center gap-2">
                                        ...
                                        <button
                                          ...
                                          aria-label={`Save stock level for ${ing.name}`}
                                          className={`flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-lg transition-all duration-150 cursor-pointer ${
                                            adjustQty[ing.id] !== undefined &&
                                            adjustQty[ing.id] !== ing.available_stock
                                              ? "bg-primary hover:bg-primary-hover text-white opacity-100 scale-100"
                                              : "bg-slate-100 text-slate-300 opacity-0 scale-95 pointer-events-none"
      ...
      <GiftSetBuilderModal
        ...
        products={products}
        onSaveGiftSet={handleSaveGiftSet}
      />
    </div>
  );
}
