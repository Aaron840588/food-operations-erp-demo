...
export const Modal = ({ isOpen, onClose, title, children, size = "md" }: ModalProps) => {
  ...
  return (
    <div className="app-safe-modal fixed inset-0 z-[70] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-fade-in touch-optimize">
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 bg-white px-4 py-3 sm:px-6 sm:py-4">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/35"
          >
            <X size={16} />
          </button>
        </div>
