...
export function DataTableScroll({ label, className = "", ...props }: DataTableScrollProps) {
  return (
    <div
      ...
      aria-label={label}
      tabIndex={0}
      className={`scroll-fade-x overflow-x-auto pb-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/30 ${className}`}
      {...props}
    />
  );
}
